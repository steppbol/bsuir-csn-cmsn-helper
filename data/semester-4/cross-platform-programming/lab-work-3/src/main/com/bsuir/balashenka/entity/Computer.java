...
public class Computer {
    ...
    /**
     * Property - ArrayList of films.
     */
    private ArrayList<Videofile> films = new ArrayList<>();
     ...
     */
    public Computer() {
        browsers.add(new Browser("Internet Explorer", "Microsoft", "D:/Program"));
        players.add(new Player("Groove", "Microsoft", "D:/Program"));
    }
    ...
    /**
     * Add films in collection.
     *
     * @param videofile films
     */
    public void addFilmComputer(final Videofile videofile) {
        films.add(new GUI().ZERO, videofile);
    }
     ...
     */
    public ArrayList<Videofile> getFilms() {
        return films;
    }

    /**
     * @param filmsTemp array of films
     */
    public void setFilms(final ArrayList<Videofile> filmsTemp) {
        this.films = filmsTemp;
    }
}
