...
public class GUI extends Pane implements Constants {
    ...
    public GUI() {
        ...
        HBox userNameHbox = new HBox(SPACE_FIVE);
        nameOfUserTextField = new TextField();
        nameOfUserTextField.setPromptText("Introduce yourself");
        nameOfUserTextField.setPrefWidth(MAX_WIDTH_FIELD);
        userText = new Text("User");
        userNameHbox.getChildren().addAll(userText, nameOfUserTextField);
        userText.setFont(Font.font("", FontWeight.NORMAL, SIZE_TEXT));
        grid.add(userNameHbox, COLUMN_INDEX, ROW_INDEX_0);
        ...
        pathTextField.setPrefWidth(MAX_WIDTH);
        pathTextField.setPromptText("Path");

        userVBox.getChildren().addAll(nameTextField, authorTextField, pathTextField);
        ...
        HBox playerHBox = new HBox(SPACE_FIVE);
        playerText = new Text("Player");
        playerText.setFont(Font.font("", FontWeight.NORMAL, SIZE_TEXT));
        formatTextField = new TextField();
        formatTextField.setPrefWidth(MAX_WIDTH_FIELD);
        formatTextField.setPromptText("Format of video");
        playerHBox.getChildren().addAll(playerText, formatTextField);
        grid.add(playerHBox, COLUMN_INDEX, ROW_INDEX_19);
